...
- OAuth login support (Kakao, Google) - See [OAUTH_SETUP.md](./OAUTH_SETUP.md) for setup instructions
...
5. Create tables and insert sample data:
   ...
   Head over to the [SQL Editor](https://app.supabase.com/project/_/sql/new) in your Supabase project dashboard and run the SQL from `supabase/seed.sql`:
   ...
   Or copy and paste the contents of `supabase/seed.sql` into the SQL Editor and click **RUN**.
